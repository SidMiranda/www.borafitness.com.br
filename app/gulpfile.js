...
const paths = {
	src: './src/',
	dest: '../wp-content/themes/borafitness/'
};
...
gulp.task('server', 
	function(callback){
		runSequence('clean',['php', 'clean-css', 'libs-server', 'css-server', 'js-server', 'js-server-ie', 'img', 'fonts', 'assets' ],callback);
	}
);
...
gulp.task('default', 
	function(callback){
		runSequence('clean',['php', 'clean-css', 'css', 'libs', 'js', 'js-ie', 'img', 'fonts', 'assets'],'watch',callback);
	}
);